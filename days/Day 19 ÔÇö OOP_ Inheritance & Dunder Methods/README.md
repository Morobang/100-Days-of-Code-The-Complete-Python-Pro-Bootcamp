...
## Learning objectives
- Build a class hierarchy with `super()`
- Override methods in subclasses
- Implement dunder methods for operators
...
|------|------|-----------|
| 1 | `01_learn.ipynb` | Read + run every cell — don't skip |
...
---
*Push before moving on: `git add . && git commit -m "day 19: oop: inheritance & dunder methods" && git push`*
